#!/usr/bin/env python3
"""Test TFT training loop after batch unpacking fix."""
import csv
...
hospital_id = "TRAIN-LOOP-001"
password = "TrainLoop123!"

requests.post(
    f"{BASE_URL}/api/auth/register",
    json={
        "hospital_name": "Train Loop Hospital",
        "hospital_id": hospital_id,
        "contact_email": "trainloop@test.hospital",
        "location": "Test City",
        "password": password,
        "role": "HOSPITAL",
    },
...
csv_path = Path("./storage/datasets/train_loop.csv")
...
with open(csv_path, "rb") as f:
    files = {"file": f}
    data = {"name": "Train Loop Dataset", "description": "Train loop test"}
